    ...
    <div className="relative w-full h-full">
      ...
      {(() => {
        ...
        if (isMultiSpecies) {
          ...
          return (
            <div
              ...
              className="absolute bottom-16 md:bottom-8 left-3 backdrop-blur-xl bg-white/85 dark:bg-gray-900/85 rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 px-3.5 py-2.5"
        ...
        return (
          <div
            data-testid="map-legend"
            className="absolute bottom-16 md:bottom-8 left-3 backdrop-blur-xl bg-white/85 dark:bg-gray-900/85 rounded-lg md:rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 px-2 py-1.5 md:px-3.5 md:py-2.5"
