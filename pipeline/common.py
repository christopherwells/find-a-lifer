...
SUB_REGIONS = {
    "ca-west": ("Western Canada & Alaska",
                {"CA-BC", "CA-AB", "US-AK", "CA-YT"},
                [-180, 48, -125, 72]),
    "ca-central": ("Central Canada",
                   {"CA-SK", "CA-MB", "CA-ON", "CA-NT", "CA-NU"},
                   [-120, 42, -75, 84]),
    "ca-east": ("Eastern Canada & North Atlantic Islands",
                {"CA-QC", "CA-NB", "CA-NS", "CA-NL", "CA-PE", "PM", "GL"},
                [-75, 42, -10, 84]),
